                    ...
                    <form id="form-member" method="POST" class="form-horizontal"
                        ...
                        <div class="card ">
                            <div class="card-header card-header-primary">
                                ...
                                <p class="card-category">{{ __('type information') }}</p>
                            </div>
                            <div class="card-body ">
                                @if (session('status'))
                                    <div class="row">
                                ...
                                @endif
                                @component('admin.type.formulario', ['type' => isset($type) ? $type : null])
                                @endcomponent
                            </div>
                            <div class="card-footer ml-auto mr-auto">
                                <button type="submit" class="btn btn-success">{{ __('Save') }}</button>
                                <a href="{{ route('type.index') }}" class="btn btn-secondary">Voltar</a>
                            </div>
                        </div>
                    </form>
                </div>
