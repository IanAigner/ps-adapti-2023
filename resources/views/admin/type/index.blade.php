@extends('layouts.app', ['activePage' => 'type-management', 'titlePage' => __('type')])
    ...
    <div class="content">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <a class="float-right" href="{{ route('type.create') }}">
                                <button type="button" title="{{ __('Add type') }}" class="btn btn-primary add-button">
                                    <i class="material-icons">add_circle_outline</i>{{ __('Add type') }}
                                </button>
                            </a>
                            <h4 class="card-title ">{{ __('type') }}</h4>
                            <p class="card-category">{{ __('Lista de todos os types') }}</p>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" title="{{ __('Delete') }}" data-toggle="modal"
                                                        data-target="#modal-excluir" data-id="{{ $type->id }}"
                                                    ...
                                                    <button type="button" title="{{ __('Visualizar') }}"
                                                        ...
                                                        data-id="{{ $type->id }}" class="btn btn-danger">
        ...
        <div id="modal-excluir" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body" align="center">Tem certeza de que quer excluir esse type?
                    </div>
        ...
        <div id="modal-detalhes" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title col-12 text-dark" id="serviceModalLabel">Visualização do type</h5>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 col-sm-12">
                                <h5 class="modal-title col-12 text-dark" id="serviceModalLabel">Nome do type</h5>
                                <input type="text" id="detalhes-nome" name="detalhes-nome" class="form-control" readonly>
                            </div>

                            <div class="form-group col-md-12 col-sm-12">
                                <h5 class="modal-title col-12 text-dark" id="serviceModalLabel">Descrição do type</h5>
                            ...
                            <div class="form-group col-md-12 col-sm-12">
                                <h5 class="modal-title col-12 text-dark" id="serviceModalLabel">Curso do type</h5>
...
@push('js')
    ...
    <script>
        ...
        $('#modal-excluir').on('show.bs.modal', function(event) {
            ...
            const id = button.data('id')
            const url2 = 'type/' + id
            $('#form-excluir').attr('action', 'type/' + id)
        })
    </script>
@endpush
